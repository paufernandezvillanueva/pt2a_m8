            ...
            <div>
                ...
                <select name="autor_id">
                    <?php $__currentLoopData = $autors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($autor->id); ?>" <?php if($autor->id == $llibre->autor_id): echo 'selected'; endif; ?>><?php echo e($autor->nom); ?> <?php echo e($autor->cognoms); ?></option>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/m7_1/UF2/pt2a/resources/views/llibre/edit.blade.php ENDPATH**/ ?>